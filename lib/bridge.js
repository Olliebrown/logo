...
function Bridge () {
    ...
    this.buffer         = [];
    this.commands       = ['begin', 'end', 'move', 'turn', 'setposition', 'setheading', 'home', 'arc', 'showturtle' , 'hideturtle', 'clear', 'clearscreen', 'print', 'pendown', 'penup', 'setpenmode', 'setpencolor', 'setwidth', 'setscreencolor'];
    this.limit          = 25000;
    ...
    this.convert = function () {
        ...
        // Test if the buffer limit has been reached
        // Note: we stop one from the limit so there is room for the 'end' command
        a.limitReached = function() {
            return (self.buffer.length >= self.limit - 1);
        };
